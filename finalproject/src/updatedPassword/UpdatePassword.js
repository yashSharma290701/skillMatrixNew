...
//         <MDBInput wrapperClass='mb-4 mx-5 w-100' labelClass='text-white'  label='default-Password' id='formControl' type='password' size="lg"
//         value={data.defaultPassword} name = "defaultPassword" onChange={handleEvent}/>
//         <MDBInput wrapperClass='mb-4 mx-5 w-100' labelClass='text-white' label='New password' id='formControlled' type='password' size="lg"
            ...
            <MDBCard className='bg-dark text-white my-5 mx-auto' style={{ borderRadius: '1rem', maxWidth: '400px' }}>
              <MDBCardBody className=' cardBackground p-4 d-flex flex-column align-items-center mx-auto w-100'>
                ...
                <MDBInput wrapperClass='mb-4 mx-5 w-100' labelClass='text-white' label='New Password' id='formControlled' type='password' size="lg"
                  value={data.newPassword} name="newPassword" onChange={handleEvent} />
                <Button variant="info" type="submit" className='mb-2 p-3' onClick={handleSubmit}><strong>Change Password</strong></Button>{' '}
                <p className="text-white-50 mb-5"><a href="/" className="text-white-50 mb-5">Sign In</a></p>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
        </MDBRow>
