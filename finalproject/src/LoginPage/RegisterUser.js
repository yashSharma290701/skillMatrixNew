...
function RegisterUser() {
  ...
  return (
    <div  >
      <Navbar />
      <div class="container-fluid p-0 text-center addUser">
       
            <SideBar />
            <div className='container-fluid createUser m-3'>
            <MDBContainer >
              <MDBRow className='justify-content-center align-items-center '>
                <MDBCard >
                  <MDBCardBody className=' certificateDetails' style={{marginLeft:"2rem"}} >
